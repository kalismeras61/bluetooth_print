 ...
 * @author thon
 */
public class BluetoothPrintPlugin implements FlutterPlugin, ActivityAware, MethodCallHandler, ActivityPluginBinding.OnRequestPermissionsResultListener {
    ...
    private void printTest(Result result) {
        ...
        if (deviceConnFactoryManager == null || !deviceConnFactoryManager.getConnState()) {
            result.error("not_connect", "state not right", null);
            return;
        }
